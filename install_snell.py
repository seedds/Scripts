...
print(f'snell, {ip4}, {shadow_port}, psk={snell_psk}, version={snell_version}, shadow-tls-password={shadow_psk}, shadow-tls-sni=gateway.icloud.com, shadow-tls-version=3')
print('=' * 20)
